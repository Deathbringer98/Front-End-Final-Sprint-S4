        ...
        <div className="search-page">
            <div className="background-container">
                ...
                <div className="search-results">
                    ...
                    {movies.length > 0 ? (
                        movies.map(movie => (
                            <div key={movie.movie_id} className="movie-item"> {/* Ensure unique key */}
                                <h3>{movie.title}</h3>
                                <p><strong>Director:</strong> {movie.director}</p>
                                <p><strong>Genre:</strong> {movie.genre}</p>
                                <p><strong>Release Year:</strong> {movie.release_year ? movie.release_year : "N/A"}</p> {/* Use correct reference */}
